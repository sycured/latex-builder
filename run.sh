...
buildah run "$mkimg" -- microdnf --nodocs --setopt=install_weak_deps=0 --best install -y cmake ghostscript ninja-build rclone texlive texlive-chktex texlive-luatex texlive-collection-latexextra texlive-collection-fontsextra
