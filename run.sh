...
buildah run "${mkimg}" -- zypper install -y cmake ghostscript git gzip perl-Image-ExifTool poppler-tools qpdf rclone samurai shadow tar texlive texlive-chktex texlive-luatex texlive-collection-latexextra texlive-collection-fontsextra texlive-lexend
